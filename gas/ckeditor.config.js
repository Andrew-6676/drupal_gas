...
CKEDITOR.editorConfig = function(config) {
 ...
 /**
  ...
  if (Drupal.settings.ckeditor.theme == "marinelli") {
	...
	//config.contentsCss = '/drupal/sites/all/themes/gas/css/page.css';
...
//        config.startupOutlineBlocks = true;
        ...
        ///var kc_path = 'sites/all/libraries';
...
//        config.filebrowserFlashUploadUrl        = kc_path+'/kcfinder/upload.php?type=flash';
  ...
  config.filebrowserBrowseUrl = '/drupal/sites/all/libraries/kcfinder/browse.php?opener=ckeditor&type=files';
  config.filebrowserImageBrowseUrl = '/drupal/sites/all/libraries/kcfinder/browse.php?opener=ckeditor&type=images';
  config.filebrowserFlashBrowseUrl = '/drupal/sites/all/libraries/kcfinder/browse.php?opener=ckeditor&type=flash';
  config.filebrowserUploadUrl = '/drupal/sites/all/libraries/kcfinder/upload.php?opener=ckeditor&type=files';
  config.filebrowserImageUploadUrl = '/drupal/sites/all/libraries/kcfinder/upload.php?opener=ckeditor&type=images';
  config.filebrowserFlashUploadUrl = '/drupal/sites/all/libraries/kcfinder/upload.php?opener=ckeditor&type=flash';
